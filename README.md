...
A teaching compiler that uses a C-like input language, outputs LLVM IR, and then outputs x86 and ARM machine language. This is version 3. Version 1 available [here](https://github.com/meuer26/SimpleCompilerv1). This was written between 2023-2025 for teaching compiler concepts.
